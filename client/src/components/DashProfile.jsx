  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
            ...
            <div className="relative rounded-full size-28 aspect-[1/1] self-center cursor-pointer shadow-md" onClick={() => filePickerRef.current.click()}>
        ...
        {error && (
         ...
         <Modal show={showModel} size="md" onClose={() => setShowModal(false)} popup>
         <Modal.Header />
         <Modal.Body>
